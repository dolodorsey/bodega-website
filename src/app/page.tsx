    ...
    <main style={{ minHeight: '100vh', background: '#080808' }}>
      ...
      <section style={{
        ...
        <div style={{ display: 'flex', gap: 12, marginTop: 40, flexWrap: 'wrap', justifyContent: 'center' }}>
          <KHGFormButton formType="inquiry" brandKey="bodega" variant="accent" size="lg" label="Get In Touch" />
          <KHGFormButton formType="sponsor" brandKey="bodega" variant="outline" size="lg" />
        </div>
      </section>
      ...
      <section style={{ padding: '80px 24px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        <div style={{
          ...
          <KHGFormButton formType="inquiry" brandKey="bodega" variant="default" />
          <KHGFormButton formType="consultation" brandKey="bodega" variant="default" />
          <KHGFormButton formType="hiring_inquiry" brandKey="bodega" variant="default" />
          <KHGFormButton formType="volunteer" brandKey="bodega" variant="default" />
          <KHGFormButton formType="rsvp" brandKey="bodega" variant="default" />
          <KHGFormButton formType="nda" brandKey="bodega" variant="default" />
        </div>
      </section>
    </main>
  );
