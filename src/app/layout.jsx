...
const NAV=[{label:'New In',href:'/shop'},{label:'Departments',href:'/#rooms'},{label:'Brand Rooms',href:'/#rooms'},{label:'Shop All',href:'/shop'}];
...
export default function RootLayout({children}){
 return <html lang="en" className={`${display.variable} ${body.variable}`}><body>
  ...
  <footer className="footer"><div className="footer__grid">
   ...
   <div><div className="footer__heading">Store</div><a href="/shop" className="footer__link">Shop All</a><a href="/#rooms" className="footer__link">Brand Rooms</a><a href="/#subscribe" className="footer__link">Drop List</a></div>
