    ...
    <main style={{ minHeight: '100vh', background: '#080808' }}>
      ...
      <section style={{ padding: '80px 24px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap', maxWidth: 800, margin: '0 auto' }}>
          <KHGFormButton formType="inquiry" brandKey="bodega" />
          <KHGFormButton formType="consultation" brandKey="bodega" />
          <KHGFormButton formType="hiring_inquiry" brandKey="bodega" />
          <KHGFormButton formType="volunteer" brandKey="bodega" />
          <KHGFormButton formType="rsvp" brandKey="bodega" />
          <KHGFormButton formType="nda" brandKey="bodega" />
        </div>
      </section>
    </main>
  );
